...
class AppointmentController extends Controller
{
    ...
    public function index()
    {
        ...
        $confirmedAppointments = Appointment::whereDate('appointment_date', $today)
            ->where('status', 'confirmed')->count();
        $pendingAppointments = Appointment::whereDate('appointment_date', $today)
        ...
        $todayAppointmentsList = Appointment::with(['patient', 'pt'])
            ->whereDate('appointment_date', $today)
            ->orderBy('appointment_time')
            ->get();

        // Get all appointments for calendar
        $allAppointments = Appointment::with(['patient', 'pt', 'branch'])
    ...
    {
        $appointments = Appointment::with(['patient', 'branch', 'pt'])
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'booking_channel' => 'required|in:walk_in,phone,line,website,other,ads,facebook,referral,company',
